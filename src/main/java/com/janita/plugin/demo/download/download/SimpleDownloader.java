...
import com.janita.plugin.demo.download.ext.ByteArrayResponseExtractor;
import com.janita.plugin.demo.download.support.DownloadProgressPrinter;
...
public class SimpleDownloader extends AbstractDownloader {
    ...
    protected void doDownload(String fileURL, String dir, String fileName, HttpHeaders headers) throws IOException {
        ...
        byte[] body = restTemplate.execute(fileURL, HttpMethod.GET, null, new ByteArrayResponseExtractor(downloadProgressPrinter));
